...
AbrisPlatform::AbrisPlatform(HTTPClient * http, const char * address){
	this->http = http;
	this->address = "http://"+ String(address) + "/Server/request.php";
};
...
void AbrisPlatform::setHTTPAddress(const char * address){
	this->address = "http://" + String(address) + "/Server/request.php";
};
